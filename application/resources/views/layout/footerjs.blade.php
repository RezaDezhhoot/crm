...
<script src="public/js/core/persian-date.min.js?v={{ config('system.versioning') }}"></script>
<script src="public/js/core/persian-datepicker.min.js?v={{ config('system.versioning') }}"></script>
