        ...
        <div class="navbar-collapse header-overlay" id="main-top-nav-bar">
            ...
            <ul class="navbar-nav navbar-top-right my-lg-0">
                ...
                <li class="nav-item dropdown d-none d-sm-block" >
                    <a target="_blank" title="ورود به ویدئو کنفرانس" class="nav-link dropdown-toggle font-22 waves-dark text-danger p-t-9" href="https://meet.sorenacrm.com/?room=6589528565eee">
                        <i class="ti-camera display-inline-block text-primary"></i>
                    </a>
