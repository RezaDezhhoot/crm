...
{{--                departments --}}
                <li data-modular-id="main_menu_team_leads"
                    class="sidenav-menu-item {{ request()->routeIs('admin.departments') ? 'active' : '' }} menu-tooltip menu-with-tooltip"
                    title="{{ cleanLang(__('lang.leads')) }}">
                    <a class="waves-effect waves-dark" href="{{route('admin.departments')}}" aria-expanded="false" target="_self">
                        <i class="icon-Building"></i>
                        <span class="hide-menu">{{ cleanLang(__('lang.departments')) }}
                        </span>
                    </a>
                </li>
