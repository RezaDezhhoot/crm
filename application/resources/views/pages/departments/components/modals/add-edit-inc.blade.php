<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <textarea class="form-control form-control-sm" id="description" name="description">{{ $department->description ?? '' }}</textarea>
            </div>
        </div>
        ...
        <div class="client-selector-container" id="client-existing-container">
            <div class="form-group row">
                <label
                        class="col-sm-12 col-lg-3 text-left control-label col-form-label required">مدیران</label>
                <div class="col-sm-12 col-lg-9">
                    <!--select2 basic search-->
                    <select name="managers" id="managers" multiple="multiple"
                        ...
                        @if(isset($page['section']) && $page['section'] == 'edit' && $department->managers)
                    ...
                    <div class="col-sm-12 col-lg-9">
                        ...
                        <select name="parent_id" id="parent_id" data-allow-clear="true"
                            ...
                            @foreach($departments as $item)
                                <option {{ (isset($department) && $department->parent_id == $item->id) ? 'selected' : '' }} value="{{$item->id}}">
                                    {{ $item->title }}
                                </option>
                            @endforeach
                        </select>
