@foreach($departments as $item)
    <tr data-toggle="collapse" data-target="#child{{$item->id}}" class="accordion-toggle" id="item_{{ $item->id }}">
         ...
         <span class="list-table-action dropdown font-size-inherit">
                 <!--[delete]-->
                     <button type="button" title="{{ cleanLang(__('lang.delete')) }}"
                             ...
                             data-url="{{ route('admin.departments.delete',$item->id) }}">
             ...
             <!--[edit]-->
                     <button type="button" title="{{ cleanLang(__('lang.edit')) }}"
                             ...
                             data-url="{{ route('admin.departments.edit',$item->id) }}"
                             data-loading-target="commonModalBody" data-modal-title="{{ cleanLang(__('lang.edit_department')) }}"
                             data-action-url="{{ route('admin.departments.update',$item->id)  }}" data-action-method="PUT"
        ...
        @if($item->children)
            @include('pages.departments.components.table.tree-items',['children' => $item->children,'parent' => $item])
        @endif
    </tr>
@endforeach
