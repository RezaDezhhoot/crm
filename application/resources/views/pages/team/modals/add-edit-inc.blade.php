...
<div class="row">
    <div class="col-lg-12">
                    ...
                    <select name="departments" id="departments"
                        ...
                        @if(isset($page['section']) && $page['section'] == 'edit')
                            @foreach($user->departments as $department)
                                @php $selected_departments[] = $department->id ; @endphp
                            @endforeach
                        @endif
                        <!--/#array of selected tags-->
                        @foreach($departments as $key => $department)
                            <option value="{{ $key }}"
                                    {{ runtimePreselectedInArray($key ?? '', $selected_departments  ?? []) }}>
                                {{ $department }}
                            </option>
                        @endforeach
                    </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm" name="role_id">
                    <option></option>
