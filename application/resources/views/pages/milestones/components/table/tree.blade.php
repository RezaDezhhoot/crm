@foreach($milestones as $milestone)
    <tr data-toggle="collapse" data-target="#child{{$milestone->milestone_id}}" class="accordion-toggle" id="milestone_{{ $milestone->milestone_id }}">
        ...
        <td class="milestones_col_name">
            ...
            <a class="js-dynamic-url js-ajax-ux-request" data-loading-target="embed-content-container"
               ...
               href="#projects_ajaxtab">{{ runtimeLang($milestone->milestone_title, 'task_milestone').'@'.$milestone->milestone_id }}</a>
    ...
    <tr>
        @include('pages.milestones.components.table.tree-items',['children' => $milestone->children,'parent' => $milestone])
    </tr>
@endforeach
