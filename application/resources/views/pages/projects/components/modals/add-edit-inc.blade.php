<div class="row" id="js-projects-modal-add-edit" data-section="{{ $page['section'] }}"
    ...
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label">پروژه والد</label>
            <div class="col-sm-12 col-lg-9">
{{--                @if(isset($page['section']) && $page['section'] == 'edit')--}}
...
{{--                @endif--}}
                <select name="parent_id" id="parent_id" class="form-control form-control-sm js-select2-basic-search-modal select2-hidden-accessible"
                        data-allow-clear="true"  data-ajax--url="{{ url('/') }}/feed/projects-search">
                    <!--array of assigned-->
                    ...
                    <!--/#users list-->
                    @if(isset($page['section']) && $page['section'] == 'edit' && isset($project) && isset($project->parent))
                        <option value="{{$project->parent->project_id}}">
                            {{ $project->parent->project_title }}
                        </option>
                    @endif
                </select>
            </div>
        ...
        <div class="form-group row">
            <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label">درجه سختی(درصد)</label>
            <div class="col-sm-12 col-lg-9">
                <input type="number" min="1" max="100" class="form-control form-control-sm" name="difficulty"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm pickadate" name="project_date_due"
                    autocomplete="off" value="{{ runtimeDatepickerDate($project->project_date_due ?? now()->addMonth()) }}">
            </div>
        </div>
        <!--/#DUE DATE-->
        ...
        <div class="spacer row">
            ...
            <div class="col-sm-4 text-right">
                <div class="switch">
                    <label>
                        <input type="checkbox" {{ ( isset($page['section']) && $page['section'] == 'edit' && isset($project) && sizeof($project->assigned) == 0) ? "checked" : '' }}  class="js-switch-toggle-hidden-content"
        ...
        <div class="hidden" id="edit_category_and_users" style=" {{ ( isset($page['section']) && $page['section'] == 'edit' && isset($project) && sizeof($project->assigned) == 0) ? "display:block" : '' }}">
            ...
            <!--project manager<>-->
            @if(config('visibility.project_modal_assign_fields'))
            <div class="form-group row border border-success py-3">
                <label
            ...
            <div class="client-selector-container" id="supervisor-existing-container">
                <div class="form-group row">
                    <label
                            class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ cleanLang(__('lang.supervisor')) }}</label>
                    <div class="col-sm-12 col-lg-9">
                        <!--select2 basic search-->
                        <select name="supervisor" id="supervisor"
                                class="form-control form-control-sm js-select2-basic-search-modal select2-hidden-accessible"
                                multiple="multiple" data-ajax--url="{{ url('/') }}/feed/contacts">


                            @if(isset($page['section']) && $page['section'] == 'edit' && isset($project->supervisors))
                                @foreach($project->supervisors as $user)
        ...
        @endif
            <div class="form-group form-group-checkbox row">
                <div class="col-12 text-left p-t-5">
                    <input type="checkbox" value="1" id="is_locked" {{ ( isset($project->is_locked) && $project->is_locked) ? 'checked' : '' }} name="is_locked"
                           class="filled-in chk-col-light-blue" >
                    <label for="is_locked">قفل پروژه</label>
                </div>
            </div>
    </div>
</div>