<div>
    <div class="card-comments" id="post-card-comment-form">
        <div class="x-heading"><i class="mdi mdi-message-text"></i>بازخوردهای مدیر</div>
        <div class="x-content">
                    ...
                    <div class="x-button m-0 p-b-10 text-right ">
                        ...
                        <div>
                            ...
                            <button type="button" class="btn btn-danger btn-sm x-submit-button" id="card-comment-post-button"
                                    data-url="{{ urlResource('/tasks/'.$task->task_id.'/admin-reports') }}" data-type="form" data-ajax-type="post"
