...
class Milestones extends Controller {
    ...
    public function index() {
        ...
        $milestones = $this->milestonerepo->search(tree: true);
    ...
    public function create() {
        ...
        $payload = [
            'page' => $page,
            'milestones' => $this->milestonerepo->search(paginate: 100000)
        ];
    ...
    public function store() {
        ...
        $validator = Validator::make(request()->all(), [
            ...
            'parent_id' => ['nullable','exists:milestones,milestone_id']
        ], $messages);
    ...
    public function edit($id) {
        ...
        $payload = [
            'page' => $page,
            'milestone' => $milestone,
            'milestones' => $this->milestonerepo->search(ignore: [$id],paginate: 100000)
        ];
    ...
    public function update($id) {
        ...
        $validator = Validator::make(request()->all(), [
            'milestone_title' => 'required',
            'parent_id' => ['nullable','exists:milestones,milestone_id',Rule::notIn([$id])]
        ], $messages);
