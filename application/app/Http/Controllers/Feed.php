...
class Feed extends Controller {
    ...
    public function milestones(MilestoneRepository $milestoneRepository) {
        $feed = $milestoneRepository->autocompleteNames(request('type'), request('term'));
    ...
    public function projectsSearch(ProjectRepository $projectrepo) {

        //default
        $feed = [];

        $feed = $projectrepo->autocompleteFeed2('', '', request('term'));
