...
//        $str_date = str_replace('-', ',', request('reminder_datetime'));
//        $date = Verta::getGregorian($str_date);
//        dd($date);
//        $gam_date_held = convert_numbers(request('reminder_datetime'));
//        $persian_date = explode("-", $gam_date_held);
//        $year = $persian_date[0];
//        $month = $persian_date[1];
//        $day = $persian_date[2];

//        $main_date = jalali_to_gregorian($year, $month, $day, '-') . ' ' . request('reminder_datetime') . ':' . '00';
        dd(runtimeDate(request('reminder_datetime')));
        //validate
        ...
        if (\Carbon\Carbon::now()->gt(\Carbon\Carbon::parse(ChangeDateBeforeValidationReminder(request('reminder_datetime'))))) {
