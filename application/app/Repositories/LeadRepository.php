...
class LeadRepository {
    ...
    public function create($position = '') {
        ...
        $lead->lead_last_contacted = ChangeDateBeforeValidation(request('lead_last_contacted')); //or \Carbon\Carbon::now()
    ...
    public function update($id) {
        ...
        $lead->lead_description = request('lead_description');
        $lead->lead_value = request('lead_value');
        $lead->lead_last_contacted = ChangeDateBeforeValidation(request('lead_last_contacted'));
        $lead->lead_status = request('lead_status');
