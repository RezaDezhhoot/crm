...
//    ];
    ...
    {
        return $this->hasMany(Reports::class,'task_id');
    }

    public function getIsDepartmantManagerAttribute()
    {
        $users = $this->assigned()
            ->with('departments','departments.managers')
            ->get();
    ...
    {
        return $this->belongsToMany(Skill::class,'task_skill','task_id','skill_id');
    }

    public function supervisors()
    {
        return $this->belongsToMany(User::class,'task_supervisor','task_id','user_id');
    }
}
