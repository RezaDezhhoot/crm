...
class Milestone extends Model {
    ...
    public function getMilestoneCountTasksAllChildAttribute()
    {
        return $this->tasks()->count();
    }

    public function getMilestoneCountTasksPendingChildAttribute()
    {
        return $this->tasks()->whereNotIn('task_status',[2])->count();
    }

    public function getMilestoneCountTasksCompletedChildAttribute()
    {
        return $this->tasks()->where('task_status',2)->count();
    }
    ...
    {
        return $this->belongsTo(self::class,'parent_id')->where('parent_id','!=',$this->milestone_id);
    }
