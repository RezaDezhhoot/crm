...
Route::group(['prefix' => 'departments'],function (){
    Route::get('',[\App\Http\Controllers\Department::class,'index'])->name('admin.departments');
    Route::get('search',[\App\Http\Controllers\Department::class,'search'])->name('admin.search');
    Route::get('create',[\App\Http\Controllers\Department::class,'create'])->name('admin.departments.create');
    Route::post('',[\App\Http\Controllers\Department::class,'store'])->name('admin.departments.save');
    Route::get('{department}',[\App\Http\Controllers\Department::class,'edit'])->name('admin.departments.edit');
    Route::put('{department}',[\App\Http\Controllers\Department::class,'update'])->name('admin.departments.update');
    Route::delete('{department}',[\App\Http\Controllers\Department::class,'destroy'])->name('admin.departments.delete');
});

Route::group(['prefix' => 'skills' , 'as' => 'admin.'],function (){
    Route::get('',[\App\Http\Controllers\Skill::class,'index'])->name('skills');
    Route::get('search',[\App\Http\Controllers\Skill::class,'search']);
    Route::get('create',[\App\Http\Controllers\Skill::class,'create'])->name('skills.create');
    Route::post('',[\App\Http\Controllers\Skill::class,'store'])->name('skills.save');
    Route::get('{skill}',[\App\Http\Controllers\Skill::class,'edit'])->name('skills.edit');
    Route::put('{skill}',[\App\Http\Controllers\Skill::class,'update'])->name('skills.update');
    Route::delete('{skill}',[\App\Http\Controllers\Skill::class,'destroy'])->name('skills.delete');
});
...
Route::group(['prefix' => 'tasks'], function () {
    ...
    Route::get("/{task}/manager-reports", "Tasks@managerReports")->where('task', '[0-9]+');
    Route::post("/{task}/manager-reports", "Tasks@postManagerReports")->where('task', '[0-9]+');

    Route::get("/{task}/reports", "Tasks@reports")->where('task', '[0-9]+');
    Route::post("/{task}/reports", "Tasks@postReports")->where('task', '[0-9]+');

    Route::get("/{task}/client-reports", "Tasks@clientReports")->where('task', '[0-9]+');
    Route::post("/{task}/client-reports", "Tasks@postClientReports")->where('task', '[0-9]+');

    Route::get("/{task}/admin-reports", "Tasks@adminReports")->where('task', '[0-9]+');
    Route::post("/{task}/admin-reports", "Tasks@postAdminReports")->where('task', '[0-9]+');
...
Route::group(['prefix' => 'feed'], function () {
    ...
    Route::get("/milestones", "Feed@milestones");
    ...
    Route::get("/projects-search", "Feed@projectsSearch");
